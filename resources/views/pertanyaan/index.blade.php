                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs">
                            ...
                            @endphp
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('pertanyaan/1') || Request::is('prtnyaan') ? 'active' : '' }}"
                                    aria-current="page" href="{{ route('pertanyaan', 1) }}">Psikomotorik</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('pertanyaan', 4) }}"
                                    class="nav-link  {{ Request::is('pertanyaan/4') ? 'active' : '' }}">M-Chat-R</a>
                            </li>
