        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a href="#" id="sukses" data-bs-toggle="modal" data-bs-target="#tambah" class="btn icon icon-left btn-primary"><i class="bi bi-plus-circle"></i> Tambah</a>
                </div>
                <div class="card-body">
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif
                              <td>
                                <a href="#"  data-bs-toggle="modal" data-bs-target="#edit" class="btn btn-sm icon btn-primary klik_edit" 
                                pertanyaan="{{ $d->pertanyaan }}" 
                                id_pertanyaan="{{ $d->id_pertanyaan }}"
                                id_gerak="{{ $d->id_gerak }}"
                                id_kel_kpsp="{{ $d->id_kel_kpsp }}"
                                ><i class="bi bi-pencil"></i></a>
                                <a href="{{ route('del_pertanyaan', [$d->id_pertanyaan, $kelompok]) }}" onclick="return confirm('Yakin dihapus ?')" class="btn btn-sm icon btn-danger"><i class="bi bi-trash"></i></a>
                              </td>
                            </tr>
                            @endforeach
      ...
      <form action="#">
        <div class="modal-body">
          ...
          <div class="form-check form-switch">
            <input name="pilih" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked>
