                                ...
                                @foreach ($invoice_periksa as $n)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                ...
                                                <a href="#" class="readMore" id="{{ $n->id_dokter }}">read
                                                    more</a></span>
                                                @endif
                                            <span class="teksFull{{ $n->id_dokter }}"
                                                style="display:none">{{ $n->nm_dokter }} <a href="#" class="less"
                                                    id="{{ $n->id_dokter }}">less</a></span>
                                        </td>
                                        <td>{{ $n->nama_pasien }}</td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            @if (Auth::user()->id == 2)
                                                <a href="#" class="btn btn-primary edit_invoice btn-sm"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2">
                            ...
                            <input required type="hidden" class="form-control nama" disabled>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Pembayaran</label>
